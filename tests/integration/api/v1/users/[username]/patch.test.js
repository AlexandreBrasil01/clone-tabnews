...
describe("PATCH /api/v1/users/[username]", () => {
  describe("Anonymous user", () => {
    ...
    test("Succesful 'password' update", async () => {
      ...
      const correctPasswordMatch = await password.compare("newPassword1", userInDatabase.password);
      expect(correctPasswordMatch).toBe(true);

      const incorrectPasswordMatch = await password.compare("newPassword2", userInDatabase.password);
